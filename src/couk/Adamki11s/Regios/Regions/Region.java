...
public class Region extends PermChecks implements Checks {
	...
	public ArrayList<Integer> bannedItems = new ArrayList<Integer>();
	public ArrayList<Integer> allowedItems = new ArrayList<Integer>();
	
	public String welcomeMessage = "", leaveMessage = "", protectionMessage = "", preventEntryMessage = "",
	preventExitMessage = "", authenticationRequiredMessage = "", authenticationSuccessMessage = "", password = "", name = "", owner = "",
	...
	public boolean _protection = false, preventEntry = false, preventExit = false, mobSpawns = true, monsterSpawns = true,
	healthEnabled = true, pvp = true, doorsLocked = false, chestsLocked = false, preventInteraction = false,
	showPvpWarning = true, passwordEnabled = false, showWelcomeMessage = true, showLeaveMessage = true, showProtectionMessage = true,
	showPreventEntryMessage = true, showPreventExitMessage = true, fireProtection = false, tntProtection = false, creeperProtection = false,
	playCustomSoundUrl = false;
	
	public int LSPS = 0, healthRegen = 0;
	public double velocityWarp = 0;
	
	public MODE protectionMode = MODE.Whitelist, preventEntryMode = MODE.Whitelist, preventExitMode = MODE.Whitelist,
	...
	public Region(String owner, String name, Location l1, Location l2,
		...
		RegionLocation l = this.getL1();
		System.out.println(l.getWorld().getName() + "," + l.getX() + "," + l.getY() + "," + l.getZ());
		l = this.getL2();
		System.out.println(l.getWorld().getName() + "," + l.getX() + "," + l.getY() + "," + l.getZ());
		...
		System.out.println("BEFORE : " + welcomeMessage);
